...
if(isset($_GET['del'])){
   hard_delete($conn,$_GET['del'],'morcha_miniority');
}
...
$worker_details = get_morcha_miniority($conn,NULL);
                               ...
                               <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="nk-block-title" style="margin-top: 50px;">Miniority Morcha</h4>
                                                
                                            </div>
                                        </div>
                                        <form action="morcha_miniority_sms.php" method="post">
                                            <div style="text-align:right;">
                                                <a href="add_morcha_miniority.php" class="btn btn-outline-warning btn-tooltip" title="Click to add new records"><em class="icon ni ni-users"></em>&nbsp;Add New</a>
                                        ...
                                        <div class="card card-preview" style="<?php if(count($worker_details) != 0 && preg_match("/(android|avantgo|blackberry|bolt|boost|cricket|docomo|fone|hiptop|mini|mobi|palm|phone|pie|tablet|up\.browser|up\.link|webos|wos)/i", $_SERVER["HTTP_USER_AGENT"])) echo 'width: max-content;'?>">
                                            <div class="card-inner">
                                                <table class="table" id="karyakartas">
                                                    ...
                                                    <?php
                                                        $i = 1;
                                                        foreach ($worker_details as $key => $value) {
                                                    ?>
                                                        <tr>
                                                            <td><?php echo $i ?></td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="<?php echo "edit_morcha_miniority.php?id=".$value['id'];?>" class="btn btn-icon btn-trigger btn-tooltip" title="Edit this member"><em class="icon ni ni-edit"></em></a>
                                                            </td>
                                                            <td>
                                                                <div class="custom-control custom-control-sm custom-checkbox notext">
