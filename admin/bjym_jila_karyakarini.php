...
if(isset($_GET['del'])){
    hard_delete($conn,$_GET['del'],'bjym_jila_karyakarini');
}
...
$all_jilas = get_all_jilas_for_bjym_jila_karyakarini($conn);
...
$bjp_worker_details = get_bjym_jila_karyakarini($conn,$selected_jila,NULL);
                            ...
                            <div class="nk-content-body">
                               ...
                               <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="nk-block-title" style="margin-top: 50px;">BJYM Jila Karyakarini</h4>
                                                <div class="col-md-7">
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="<?php echo "edit_bjym_jila_karyakarini.php?id=".$value['id'];?>" class="btn btn-icon btn-trigger btn-tooltip" title="Edit this member"><em class="icon ni ni-edit"></em></a>
                                                            </td>
                                                            <td>
                                                                <div class="custom-control custom-control-sm custom-checkbox notext">
            ...
            $('.' + childClass + '').prop('checked', this.checked);
                ...
                $(document).ready(function() {
                    NioApp.DataTable('#karyakartas', {
                        ...
                        "columnDefs":[
                                        {
                                            "targets":[1,2,3,5,6,7,9,10,11,12,13,14],
                                            "orderable":false,
                                        },
                                    ],
                        responsive: {
