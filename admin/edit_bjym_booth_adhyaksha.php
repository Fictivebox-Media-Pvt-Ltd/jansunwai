...
if(!isset($_GET['id'])){
    header('location:bjym_booth_adhyaksh.php');
}
...
if((isset($_POST['kram']) && isset($_POST['assembly']) && isset($_POST['mandal']) && isset($_POST['booth_adhyaksh']) && isset($_POST['phone_no']) && isset($_POST['booth_no']) && isset($_POST['address']) && isset($_POST['dob']) && isset($_POST['kab_se']) && isset($_POST['kab_tak']) && isset($_POST['status']))){
     update_booth_adhyaksh1($conn,$_GET['id'],$_POST['kram'],$_POST['assembly'],$_POST['mandal'],$_POST['booth_adhyaksh'],$_POST['phone_no'],$_POST['booth_no'],$_POST['address'],$_POST['dob'],$_POST['kab_se'],$_POST['kab_tak'],$_POST['status']);
     header("Location: bjym_booth_adhyaksh.php");
}

$details = get_booth_adhyaksh1($conn,$_GET['id']);
