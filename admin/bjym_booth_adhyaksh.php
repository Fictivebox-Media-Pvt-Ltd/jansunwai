...
if(isset($_GET['del'])){
    hard_delete($conn,$_GET['del'],'bjym_booth_adhyaksh');
}
...
$bjp_worker_details = get_bjym_booth_adhyaksh($conn,NULL);
                               ...
                               <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="nk-block-title" style="margin-top: 50px;">BJP Booth Adhyaksh</h4>
                                                </div>
                                        </div>
                                        <form action="bjym_booth_adhyaksh_sms.php" method="post">
                                            <div style="text-align:right;">
                                                <a href="add_bjym_booth_adhyaksh.php" class="btn btn-outline-warning btn-tooltip" title="Click to add new records"><em class="icon ni ni-users"></em>&nbsp;Add New</a>
                                                ...
                                                <table class="table" id="karyakartas">
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $value['booth_adhyaksh']; ?></td>
                                                            <td><?php echo $value['phone_no']; ?></td>
                                                            <td><?php echo $value['booth_no']; ?></td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="<?php echo "edit_bjym_booth_adhyaksha.php?id=".$value['id'];?>" class="btn btn-icon btn-trigger btn-tooltip" title="Edit this member"><em class="icon ni ni-edit"></em></a>
                                                            </td>
                                                            <td>
                                                                <div class="custom-control custom-control-sm custom-checkbox notext">
