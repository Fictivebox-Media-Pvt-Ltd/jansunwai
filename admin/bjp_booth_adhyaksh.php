...
if(isset($_GET['del'])){
    hard_delete($conn,$_GET['del'],'bjp_booth_adhyaksh');
}
...
$bjp_worker_details = get_bjp_booth_adhyaksh($conn,NULL);
                        ...
                        <div class="nk-content-inner">
                            <div class="nk-content-body">
                               <div class="nk-block nk-block-lg">
                                        ...
                                        <form action="bjp_booth_adhyaksh_sms.php" method="post">
                                            <div style="text-align:right;">
                                                <a href="add_bjp_booth_adhyaksh.php" class="btn btn-outline-warning btn-tooltip" title="Click to add new records"><em class="icon ni ni-users"></em>&nbsp;Add New</a>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="<?php echo "edit_bjp_booth_adhyaksh.php?id=".$value['id'];?>" class="btn btn-icon btn-trigger btn-tooltip" title="Edit this member"><em class="icon ni ni-edit"></em></a>
                                                            </td>
                                                            <td>
                                                                <div class="custom-control custom-control-sm custom-checkbox notext">
