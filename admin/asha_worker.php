...
if(isset($_GET['del'])){
    delete_asha_worker($conn,$_GET['del']);
}
...
$asha_worker_details = get_asha_worker($conn,NULL);
                               ...
                               <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="nk-block-title" style="margin-top: 50px;">Asha Workers</h4>

                                            </div>
                                        </div>
                                        <form method="post" action="asha_worker_sms.php">
                                            <div style="text-align:right;">
                                                <a href="add_asha_worker.php" class="btn btn-outline-warning btn-tooltip" title="Click to add new records"><em class="icon ni ni-users"></em>&nbsp;Add New</a>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="<?php echo "edit_asha_worker.php?id=".$value['id'];?>" class="btn btn-icon btn-trigger btn-tooltip" title="Edit this member"><em class="icon ni ni-edit"></em></a>
                                                            </td>
                                                            <td>
                                                                <div class="custom-control custom-control-sm custom-checkbox notext">
                                                                    <input type="checkbox" class="custom-control-input chk2" name="mobile[]" id="<?php echo $value['id'] ?>" value="<?php echo $value['mobile'] ?>" >
            ...
            $('.' + childClass + '').prop('checked', this.checked);
                ...
                $(document).ready(function() {
                    NioApp.DataTable('#karyakartas', {
                        ...
                        "columnDefs":[
                                        {
                                            "targets":[1,2,3,4,6,7,9,10,11,13,14],
                                            "orderable":false,
                                        },
                                    ],
                        responsive: {
