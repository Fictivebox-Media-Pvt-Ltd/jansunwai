...
if(( isset($_POST['assembly']) && isset($_POST['name']) && isset($_POST['phone'])&& isset($_POST['vidhansabha_DOB']))){
    add_morcha_sc($conn,$_POST['assembly'],$_POST['name'],$_POST['phone'],$_POST['vidhansabha_DOB']);
...
{ 
  ...
  if(in_array($_FILES["file"]["type"],$allowedFileType)){
        ...
        $query = "INSERT INTO `morcha_sc` (`assembly`,`name`, `phone_no`,`dob`) VALUES";
        $sub_query = "";
            ...
            <div class="nk-wrap ">
                ...
                <div class="nk-block nk-block-lg">
                    ...
                    <div class="card">
                        <div class="card-inner">
                            <div class="card-head">
                                <h5 class="card-title">Add Morcha SC </h5>
                            </div>
                            <form method="POST" enctype="multipart/form-data" class="gy-3 form-validate">
                            <div class="row g-3 align-center">
                                    <div class="col-lg-5">
