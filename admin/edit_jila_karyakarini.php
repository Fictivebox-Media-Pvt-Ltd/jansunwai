...
if((isset($_POST['district']) && isset($_POST['designation']) && isset($_POST['name']) && isset($_POST['father_name']) && isset($_POST['age']) && isset($_POST['cast']) && isset($_POST['phone_no']) && isset($_POST['address']) && isset($_POST['active_membership_number']) && isset($_POST['previous_designation']) && isset($_POST['nivasi_mandal']) && isset($_POST['karyakarini_DOB']) && isset($_POST['kab_se']) && isset($_POST['kab_tak']) && isset($_POST['status']))){
    ...
    update_bjp_jila_karyakarini($conn,$_GET['id'],$_POST['district'],$_POST['designation'],$_POST['name'],$_POST['father_name'],$_POST['age'],$_POST['cast'],$_POST['phone_no'],$_POST['address'],$_POST['active_membership_number'],$_POST['previous_designation'],$_POST['nivasi_mandal'],$_POST['karyakarini_DOB'],$_POST['kab_se'],$_POST['kab_tak'],$_POST['status']);
    header("Location: bjp_jila_karyakarini.php"); 
}
...
$details = get_jila_karyakarini($conn,$_GET['id']);
