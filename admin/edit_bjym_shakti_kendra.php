...
if(!isset($_GET['id'])){
    header('location:bjym_shakti_kendra.php');
}
if((isset($_POST['kram']) && isset($_POST['assembly']) && isset($_POST['mandal']) && isset($_POST['shakti_kendra_name']) && isset($_POST['prabhari']) && isset($_POST['prabhari_phone_no']) && isset($_POST['sanyojak']) && isset($_POST['sanyojak_phone_no'])&& isset($_POST['co_sanyojak'])&& isset($_POST['co_sanyojak_phone_no']) && isset($_POST['dob']) && isset($_POST['kab_se']) && isset($_POST['kab_tak']) && isset($_POST['status']))){
    update_shakti_kendrai1($conn,$_GET['id'],$_POST['kram'],$_POST['assembly'],$_POST['mandal'],$_POST['shakti_kendra_name'],$_POST['prabhari'],$_POST['prabhari_phone_no'],$_POST['sanyojak'],$_POST['sanyojak_phone_no'],$_POST['co_sanyojak'],$_POST['co_sanyojak_phone_no'],$_POST['dob'],$_POST['kab_se'],$_POST['kab_tak'],$_POST['status']);
    header('location:bjym_shakti_kendra.php');
}
$details = get_shakti_kendra1($conn,$_GET['id']);
                            ...
                            <form method="POST" enctype="multipart/form-data" class="gy-3 form-validate">
                                ...
                                <div class="row g-3 align-center">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                            <input value="<?php echo $details['mandal']?>" type="text" class="form-control" placeholder="Enter mandal" name="mandal" onkeypress="return AvoidSpace(event)">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row g-3 align-center">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                            <input value="<?php echo $details['shakti_kendra_name']?>" type="text" class="form-control" placeholder="Enter Shakti Kendra Name" name="shakti_kendra_name" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row g-3 align-center">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                            <input value="<?php echo $details['sanyojak']?>" type="text" class="form-control" placeholder="Enter sanyojak" name="sanyojak" required>
                                           </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row g-3 align-center">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                            <input value="<?php echo $details['sanyojak_phone_no']?>" type="number" class="form-control" placeholder="Enter Sanyojak Phone No" name="sanyojak_phone_no" required>
                                           </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row g-3 align-center">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                            <input value="<?php echo $details['co_sanyojak']?>" type="text" class="form-control" placeholder="Enter Co Sanyojak" name="co_sanyojak" required>
                                           </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row g-3 align-center">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                            <input value="<?php echo $details['co_sanyojak_phone_no']?>" type="number" class="form-control" placeholder="Enter Co Sanyojak Phone No" name="co_sanyojak_phone_no" required>
                                           </div>
                                        </div>
                                    </div>
                                </div>
