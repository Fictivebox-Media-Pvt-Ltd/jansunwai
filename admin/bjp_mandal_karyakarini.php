...
if(isset($_GET['del'])){
    hard_delete($conn,$_GET['del'],'bjp_mandal_karyakarini');
}
...
$bjp_worker_details = get_bjp_mandal_karyakarini($conn,NULL);
                               ...
                               <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="nk-block-title" style="margin-top: 50px;">BJP Mandal Karyakarini</h4>
                                            </div>
                                        </div>
                                        <form action="bjp_mandal_karyakarini_sms.php" method="post">
                                            <div style="text-align:right;">
                                                <a href="add_bjp_mandal_karyakarini.php" class="btn btn-outline-warning btn-tooltip" title="Click to add new records"><em class="icon ni ni-users"></em>&nbsp;Add New</a>
                                        ...
                                        <div class="card card-preview" style="<?php if(count($bjp_worker_details) != 0) echo 'width: max-content;'?>">
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="<?php echo "edit_bjp_mandal_karyakarini.php?id=".$value['id'];?>" class="btn btn-icon btn-trigger btn-tooltip" title="Edit this member"><em class="icon ni ni-edit"></em></a>
                                                            </td>
                                                            <td>
                                                                <div class="custom-control custom-control-sm custom-checkbox notext">
