...
if(isset($_GET['del'])){
    hard_delete($conn,$_GET['del'],'morcha_kissan');
}
...
$worker_details = get_morcha_kissan($conn,NULL);
                               ...
                               <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="nk-block-title" style="margin-top: 50px;">Kissan Morcha</h4>
                                               </div>
                                        </div>
                                        <form action="morcha_kissan_sms.php" method="post">
                                            <div style="text-align:right;">
                                                <a href="add_morcha_kissan.php" class="btn btn-outline-warning btn-tooltip" title="Click to add new records"><em class="icon ni ni-users"></em>&nbsp;Add New</a>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="<?php echo "edit_morcha_kissan.php?id=".$value['id'];?>" class="btn btn-icon btn-trigger btn-tooltip" title="Edit this member"><em class="icon ni ni-edit"></em></a>
                                                            </td>
                                                            <td>
                                                                <div class="custom-control custom-control-sm custom-checkbox notext">
