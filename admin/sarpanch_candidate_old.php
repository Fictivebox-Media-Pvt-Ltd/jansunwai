...
if(isset($_GET['del'])){
    delete_sarpanch_candidate($conn,$_GET['del']);
}
...
$asha_worker_details = get_sarpanch_candidate($conn,NULL);
?>
<!DOCTYPE html>
                               ...
                               <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="nk-block-title" style="margin-top: 50px;">Voters</h4>
                                                <div style="text-align:right;">
                                                <a href="add_sarpanch_candidate.php" class="btn btn-outline-warning btn-tooltip" title="Click to add new records"><em class="icon ni ni-users"></em>&nbsp;Add New</a>
