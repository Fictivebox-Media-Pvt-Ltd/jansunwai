...
if(isset($_GET['del'])){
    hard_delete($conn,$_GET['del'],'bjym_mandal_karyakarini');
}
...
$bjp_worker_details = get_bjym_mandal_karyakarini($conn,NULL);
                               ...
                               <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="nk-block-title" style="margin-top: 50px;">BJYM Mandal Karyakarini</h4>
                                                </div>
                                        </div>
                                        <form action="bjym_jila_karyakarini_sms.php" method="post">
                                            <div style="text-align:right;">
                                                    <a href="add_bjym_jila_karyakarini.php" class="btn btn-outline-warning btn-tooltip" title="Click to add new records"><em class="icon ni ni-users"></em>&nbsp;Add New</a>
                                        ...
                                        <div class="card card-preview"  style="<?php if(count($bjp_worker_details) != 0 && preg_match("/(android|avantgo|blackberry|bolt|boost|cricket|docomo|fone|hiptop|mini|mobi|palm|phone|pie|tablet|up\.browser|up\.link|webos|wos)/i", $_SERVER["HTTP_USER_AGENT"])) echo 'width: max-content;'?>">
                                            <div class="card-inner">
                                            <table class="table" id="karyakartas">
                                                    <thead>
                                                        <tr>
                                                        <th style="width:100px;">क्रम</th>
                                                            <th>विधानसभा</th>
                                                            <th>मण्डल</th>
                                                            <th>अध्यक्ष</th>
                                                            <th>अध्यक्ष मोबाईल</th>
                                                            <th>प्रभारी</th>
                                                            <th>प्रभारी मोबाईल</th>
                                                            <th>विस्तारक</th>
                                                            <th>विस्तारक मोबाईल</th>
                                                            <th>कब से</th>
                                                            <th>कब तक</th>
                                                            <th>जन्म तिथि </th>                                                            
                                                            <th>status</th>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $value['adhyaksh']; ?></td>
                                                            <td><?php echo $value['adhyaksh_phone_no']; ?></td>
                                                            <td><?php echo $value['prabhari']; ?></td>
                                                            <td><?php echo $value['prabhari_phone_no']; ?></td>
                                                            <td><?php echo $value['vistarak']; ?></td>
                                                            <td><?php echo $value['vistarak_phone_no']; ?></td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="<?php echo "edit_bjym_mandal_karyakarini.php?id=".$value['id'];?>" class="btn btn-icon btn-trigger btn-tooltip" title="Edit this member"><em class="icon ni ni-edit"></em></a>
                                                            </td>
                                                            <td>
                                                                <div class="custom-control custom-control-sm custom-checkbox notext">
                                                                    <input type="checkbox" class="custom-control-input chk2" name="mobile[]" id="<?php echo $value['id'] ?>" value="<?php echo $value['adhyaksh_phone_no'] ?>" >
