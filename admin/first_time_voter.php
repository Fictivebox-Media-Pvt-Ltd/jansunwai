...
$getFilterQuestionList = getFilterQuestionList($conn,$assignedVidhansabha);
    ...
    if(isset($_GET['isExport']) && $_GET['isExport'] != '' && $_GET['isExport'] != NULL && $_GET['isExport'] == TRUE){
       ...
       foreach($export_surveyed_userbase as $key => $value){
        ...
        $file_name = 'FirstTime-Voters.xlsx';
    ...
    <script>
        ...
        $(document).ready(function() {
                NioApp.DataTable('#voter-list', {
                    ...
                    "info":true,
                    "ajax":{
                        url:"service_for_firstTime_voters.php?booth_no=<?php echo $filter_boothRange?>&assignedLoksabha=<?php echo $assignedLoksabha ?>&filter_mandal=<?php echo $filter_mandal?>&filter_panchayat=<?php echo $filter_panchayat?>&filter_boothRange=<?php echo $filter_boothRange?>&optionFilters=<?php echo $optionFilters?>",
                        type:"POST"
                        },
                    "ordering": false,
                    responsive: {
