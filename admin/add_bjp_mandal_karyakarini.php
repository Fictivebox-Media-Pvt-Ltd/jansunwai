...
if((isset($_POST['assembly']) && isset($_POST['mandal']) && isset($_POST['adhyaksh']) && isset($_POST['adhyaksh_phone_no']) && isset($_POST['prabhari']) && isset($_POST['prabhari_phone_no']) && isset($_POST['vistarak']) && isset($_POST['vistarak_phone_no']) && isset($_POST['mandal_DOB']))){
     add_bjp_mandal_karyakarini($conn,$_POST['assembly'],$_POST['mandal'],$_POST['adhyaksh'],$_POST['adhyaksh_phone_no'],$_POST['prabhari'],$_POST['prabhari_phone_no'],$_POST['vistarak'],$_POST['vistarak_phone_no'],$_POST['mandal_DOB']);
...
{ 
  ...
  if(in_array($_FILES["file"]["type"],$allowedFileType)){
        ...
        $query = "INSERT INTO `bjp_mandal_karyakarini` (`assembly`,`mandal`, `adhyaksh`, `adhyaksh_phone_no`, `prabhari`, `prabhari_phone_no`, `vistarak`, `vistarak_phone_no`,`dob`) VALUES";
        $sub_query = "";
                                ...
                                <div class="row g-3">
                                    <div class="col-lg-7 offset-lg-5">
                                        <div class="form-group mt-2 mb-5">
                                            ...
                                            <a href="./SampleFiles/mandal_karyakarini_SampleFile.xlsx" download="" class="btn btn-lg btn-info"> Download Sample File</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
