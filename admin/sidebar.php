                        ...
                        <ul class="nk-menu-sub">
                            ...
                            <li class="nk-menu-item">
                                ...
                                <a href="javascript:void(0)" class="nk-menu-link"
                                    style="opacity: .5;color: #526484 !important;"><span class="nk-menu-text">adivasi
                                    </span></a>
                            </li>
                            <li class="nk-menu-item">
                                <!-- mahila_voter.php -->
                                <a href="javascript:void(0)" class="nk-menu-link"
                                    style="opacity: .5;color: #526484 !important;"><span class="nk-menu-text">Mahila
                                    </span></a>
                            </li>
                            <li class="nk-menu-item">
                                <!-- first_time_voter -->
                                <a href="javascript:void(0)" class="nk-menu-link"
                                    style="opacity: .5;color: #526484 !important;"><span class="nk-menu-text">First
                                        time voter
                                    </span></a>
                            </li>
                        </ul><!-- .nk-menu-sub -->
