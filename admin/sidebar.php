                ...
                <ul class="nk-menu">
                            ...
                            <ul class="nk-menu-sub">
                                ...
                                <li class="nk-menu-item">
                                    ...
                                    <ul class="nk-menu-sub">
                                        ...
                                        <li class="nk-menu-item">
                                            <!-- sangathan_list.php -->
                                            <a href="javascript:void(0)" class="nk-menu-link" style="opacity: .5;color: #526484 !important;"><span class="nk-menu-text">Sangathan List</span></a>
                                        </li>
                                    </ul>
                                </li>
                            </ul><!-- .nk-menu-sub -->
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            ...
                            <li class="nk-menu-item">
                                <!-- Youtube_media.php -->
                                <a href="javascript:void(0)" class="nk-menu-link" style="opacity: .5;color: #526484 !important;"><span class="nk-menu-text">Youtube</span></a>
                            </li>
                            <li class="nk-menu-item">
                                <!-- Social_media.php -->
                            ...
                            <li class="nk-menu-item">
                                <!-- Press_media.php -->
                                <a href="javascript:void(0)" class="nk-menu-link" style="opacity: .5;color: #526484 !important;"><span class="nk-menu-text">Press</span></a>
                            </li>
                        </ul>
                    </li>
                    <!-- .nk-menu-item -->
