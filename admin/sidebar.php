                ...
                <ul class="nk-menu">
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            ...
                            <li class="nk-menu-item">
                                <a href="adivasi_voter.php" class="nk-menu-link"><span class="nk-menu-text">Adivasi
                                        Voter
                                    </span></a>
                            </li>
                            <li class="nk-menu-item">
                                <a href="mahila_voter.php" class="nk-menu-link"><span class="nk-menu-text">Mahila
                                    </span></a>
                            </li>
                            <li class="nk-menu-item">
                                <a href="first_time_voter.php" class="nk-menu-link"><span class="nk-menu-text">First
                                        time voter
                                    </span></a>
                            </li>
                        </ul><!-- .nk-menu-sub -->
                    ...
                    <?php if ($deptName != 'Field Worker' && $deptName != 'Administrative') { ?>
                        ...
                        <li class="nk-menu-item has-sub">
                            ...
                            <ul class="nk-menu-sub">
                                ...
                                <li class="nk-menu-item">
                                    <a href="#" class="nk-menu-link nk-menu-toggle"><span class="nk-menu-text">Morcha</span></a>
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            ...
                            <li class="nk-menu-item">
                                <!-- Social_media.php -->
                                <a href="social_media.php" class="nk-menu-link"><span class="nk-menu-text">Social
                                        media</span></a>
                            </li>
                            <li class="nk-menu-item">
                                <!-- Press_media.php -->
                                <a href="press_media.php" class="nk-menu-link"><span class="nk-menu-text">Press</span></a>
                            </li>
                        </ul>
                    </li>
                    <!-- .nk-menu-item -->
