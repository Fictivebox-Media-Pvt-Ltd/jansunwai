                        ...
                        <ul class="nk-menu-sub">
                            ...
                            <li class="nk-menu-item">
                                ...
                                <ul class="nk-menu-sub">
                                    ...
                                    <li class="nk-menu-item">
                                        <a href="sangathan_list.php" class="nk-menu-link"><span
                            ...
                            <li class="nk-menu-item">
                                ...
                                <a href="javascript:void(0)" class="nk-menu-link"
                                    style="opacity: .5;color: #526484 !important;"><span
                                        class="nk-menu-text">Mukhiya</span></a>
                            </li>
                        </ul><!-- .nk-menu-sub -->
                    </li>
                    <!-- <li class="nk-menu-item has-sub">
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            ...
                            <li class="nk-menu-item">
                                <!-- Social_media.php -->
                                <a href="javascript:void(0)" class="nk-menu-link"
                                    style="opacity: .5;color: #526484 !important;"><span class="nk-menu-text">Social
                                        media</span></a>
                            </li>
                            <li class="nk-menu-item">
                                <!-- Press_media.php -->
