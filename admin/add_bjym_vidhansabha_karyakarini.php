...
if ((isset($_POST['assembly']) && isset($_POST['name']) && isset($_POST['phone']) && isset($_POST['vidhansabha_DOB']))) {
    add_bjym_vidhansabha_karyakarini($conn, $_POST['assembly'], $_POST['name'], $_POST['phone'], $_POST['vidhansabha_DOB']);
}
...
if (isset($_POST["import"])) {
    ...
    if (in_array($_FILES["file"]["type"], $allowedFileType)) {
        ...
        $query = "INSERT INTO `bjym_vidhansabha_karyakarini` (`assembly`,`name`, `phone_no`,`dob`) VALUES";
        $sub_query = "";
                        ...
                        <div class="row g-3">
                            <div class="col-lg-7 offset-lg-5">
                                <div class="form-group mt-2">
                                    ...
                                    <a href="./SampleFiles/vidhansabha_karyakarini_SampleFile.xlsx" download="" class="btn btn-lg btn-info"> Download Sample File</a>
                                </div>
                            </div>
                        </div>
                        </form>
