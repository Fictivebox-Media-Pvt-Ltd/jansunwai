...
if(( isset($_POST['sms_type']) && isset($_POST['sms']))){
    add_sms($conn,$_POST['sms_type'],$_POST['sms']);
                ...
                <div class="nk-block nk-block-lg">
                    ...
                    <div class="card">
                        <div class="card-inner">
                            <div class="card-head">
                                <h5 class="card-title">Add New SMS Template </h5>
                            </div>
                            ...
                            <div class="row g-3 align-center">
                                    <div class="col-lg-5">
                                        <div class="form-group">
                                            <label class="form-label">Type of SMS</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                            <input type="text" class="form-control" placeholder="Enter Type(example:holi,diwali,corona)" name="sms_type"  required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row g-3 align-center">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                            <input type="text" class="form-control" placeholder="Enter Your Approved Template" name="sms"  required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
