...
if(!isset($_GET['id'])){
    header('location:bjym_mandal_karyakarini.php');
}
if((isset($_POST['assembly']) && isset($_POST['mandal']) && isset($_POST['adhyaksh']) && isset($_POST['adhyaksh_phone_no']) && isset($_POST['prabhari']) && isset($_POST['prabhari_phone_no']) && isset($_POST['vistarak']) && isset($_POST['vistarak_phone_no']) && isset($_POST['dob']) && isset($_POST['kab_se']) && isset($_POST['kab_tak']) && isset($_POST['status']))){
    update_mandal_karyakarini1($conn,$_GET['id'],$_POST['assembly'],$_POST['mandal'],$_POST['adhyaksh'],$_POST['adhyaksh_phone_no'],$_POST['prabhari'],$_POST['prabhari_phone_no'],$_POST['vistarak'],$_POST['vistarak_phone_no'],$_POST['dob'],$_POST['kab_se'],$_POST['kab_tak'],$_POST['status']);
    header('location:bjym_mandal_karyakarini.php');
}
$details = get_mandal_karyakarini1($conn,$_GET['id']);
