...
if(!isset($_GET['id'])){
    header('location:bjp_shakti_kendra.php');
}
if((isset($_POST['kram']) && isset($_POST['assembly']) && isset($_POST['mandal']) && isset($_POST['shakti_kendra_name']) && isset($_POST['prabhari']) && isset($_POST['prabhari_phone_no']) && isset($_POST['sanyojak']) && isset($_POST['sanyojak_phone_no'])&& isset($_POST['co_sanyojak'])&& isset($_POST['co_sanyojak_phone_no']) && isset($_POST['dob']) && isset($_POST['kab_se']) && isset($_POST['kab_tak']) && isset($_POST['status']))){
    update_shakti_kendrai($conn,$_GET['id'],$_POST['kram'],$_POST['assembly'],$_POST['mandal'],$_POST['shakti_kendra_name'],$_POST['prabhari'],$_POST['prabhari_phone_no'],$_POST['sanyojak'],$_POST['sanyojak_phone_no'],$_POST['co_sanyojak'],$_POST['co_sanyojak_phone_no'],$_POST['dob'],$_POST['kab_se'],$_POST['kab_tak'],$_POST['status']);
    header('location:bjp_shakti_kendra.php');
}
$details = get_shakti_kendra($conn,$_GET['id']);
