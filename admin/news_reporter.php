...
if(isset($_GET['del'])){
    delete_news_reporter($conn,$_GET['del']);
}
...
$asha_worker_details = get_news_reporter($conn,NULL);
                               ...
                               <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="nk-block-title" style="margin-top: 50px;">News Reporter</h4>
                                            </div>
                                        </div>
                                        <form method="post" action="news_reporter_sms.php">
                                            <div style="text-align:right;">
                                                <a href="add_news_reporter.php" class="btn btn-outline-warning btn-tooltip" title="Click to add new records"><em class="icon ni ni-users"></em>&nbsp;Add New</a>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="<?php echo "edit_news_reporter.php?id=".$value['id'];?>" class="btn btn-icon btn-trigger btn-tooltip" title="Edit this member"><em class="icon ni ni-edit"></em></a>
                                                            </td>
                                                            <td>
                                                                <div class="custom-control custom-control-sm custom-checkbox notext">
