...
if ((isset($_POST['kram']) && isset($_POST['assembly']) && isset($_POST['mandal']) && isset($_POST['shakti_kendra_name']) && isset($_POST['prabhari']) && isset($_POST['prabhari_phone_no']) && isset($_POST['sanyojak']) && isset($_POST['sanyojak_phone_no']) && isset($_POST['co_sanyojak']) && isset($_POST['co_sanyojak_phone_no']) && isset($_POST['shakti_DOB']))) {
    add_bjp_shakti_kendra($conn, $_POST['kram'], $_POST['assembly'], $_POST['mandal'], $_POST['shakti_kendra_name'], $_POST['prabhari'], $_POST['prabhari_phone_no'], $_POST['sanyojak'], $_POST['sanyojak_phone_no'], $_POST['co_sanyojak'], $_POST['co_sanyojak_phone_no'], $_POST['shakti_DOB']);
}
                        ...
                        <div class="row g-3">
                            <div class="col-lg-7 offset-lg-5">
                                <div class="form-group mt-2 mb-5">
                                    ...
                                    <a href="./SampleFiles/shakti_kendra_SampleFile.xlsx" download="" class="btn btn-lg btn-info"> Download Sample File</a>
                                </div>
                            </div>
                        </div>
                        </form>
