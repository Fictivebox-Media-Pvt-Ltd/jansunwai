...
if ((isset($_POST['district']) && isset($_POST['designation']) && isset($_POST['name']) && isset($_POST['father_name']) && isset($_POST['age']) && isset($_POST['cast']) && isset($_POST['phone_no']) && isset($_POST['address']) && isset($_POST['active_membership_number']) && isset($_POST['previous_designation']) && isset($_POST['nivasi_mandal']) && isset($_POST['karyakarini_DOB']))) {
    add_bjym_jila_karyakarini($conn, $_POST['district'], $_POST['designation'], $_POST['name'], $_POST['father_name'], $_POST['age'], $_POST['cast'], $_POST['phone_no'], $_POST['address'], $_POST['active_membership_number'], $_POST['previous_designation'], $_POST['nivasi_mandal'], $_POST['karyakarini_DOB']);
...
if (isset($_POST["import"])) {
    ...
    if (in_array($_FILES["file"]["type"], $allowedFileType)) {
        ...
        $query = "INSERT INTO `bjym_jila_karyakarini` (`district`,`designation`, `name`, `father_name`, `age`, `cast`, `phone_no`, `address`,`active_membership_number`,`previous_designation`,`nivasi_mandal`,`dob`) VALUES";
        $sub_query = "";
                        ...
                        <div class="row g-3">
                            <div class="col-lg-7 offset-lg-5">
                                <div class="form-group mt-2 mb-5">
                                    ...
                                    <a href="./SampleFiles/jila_karyakarini_sampleFIle.xlsx" download="" class="btn btn-lg btn-info"> Download Sample File</a>
                                </div>
                            </div>
                        </div>
                        </form>
