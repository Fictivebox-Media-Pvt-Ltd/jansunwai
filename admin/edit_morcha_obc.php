...
if(( isset($_POST['assembly']) && isset($_POST['name']) && isset($_POST['phone_no']) && isset($_POST['dob']) && isset($_POST['kab_se']) && isset($_POST['kab_tak']) && isset($_POST['status']))){
    update_morcha_obc($conn,$_GET['id'],$_POST['assembly'],$_POST['name'],$_POST['phone_no'],$_POST['dob'],$_POST['kab_se'],$_POST['kab_tak'],$_POST['status']);
    header("Location: morcha_obc.php");
}
$details = get_morcha_obc($conn,$_GET['id']);
                ...
                <div class="nk-block nk-block-lg">
                    ...
                    <div class="card">
                        <div class="card-inner">
                            <div class="card-head">
                                <h5 class="card-title">Update OBC Morcha</h5>
                            </div>
